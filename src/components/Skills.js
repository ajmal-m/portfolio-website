                            ...
                            <div className="flex flex-wrap gap-1 sm:gap-2 justify-center">
                                ...
                                >
                                    ...
                                    <div className="group relative bg-black/20 flex flex-col h-24 sm:h-28 md:h-32 backdrop-blur-lg rounded-lg sm:rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                                        ...
                                        <div className="relative flex flex-col items-center justify-between w-full h-full p-2 sm:p-3">
                                            <div className="flex items-center justify-center h-[60%] w-full overflow-hidden">
                                                <img src="https://yt3.googleusercontent.com/vr50ZXiY9tM1xNgVT2cLt0sGSdL_xuvVYA0fPtzpB9-LNE32KN7bvq75Uwcz70xO-3S6Ts4zIQ=s900-c-k-c0x00ffffff-no-rj" className="w-auto h-full max-h-8 sm:max-h-10 md:max-h-12 object-contain transition-all duration-300 transform group-hover:scale-110 group-hover:brightness-110" alt="" srcset="" />
                                            </div>

                                            <div className="h-[40%] flex items-center justify-center w-full">
                                                <h2 className="font-bold text-center text-xs sm:text-sm text-white/90 transition-all duration-300 group-hover:text-white font-popinsMedium">Docker</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="group relative bg-black/20 flex flex-col h-24 sm:h-28 md:h-32 backdrop-blur-lg rounded-lg sm:rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:-translate-y-1">
                                        ...
                                        <div className="relative flex flex-col items-center justify-between w-full h-full p-2 sm:p-3">
                                            <div className="flex items-center justify-center h-[60%] w-full overflow-hidden">
                                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Kubernetes_logo_without_workmark.svg/2109px-Kubernetes_logo_without_workmark.svg.png" className="w-auto h-full max-h-8 sm:max-h-10 md:max-h-12 object-contain transition-all duration-300 transform group-hover:scale-110 group-hover:brightness-110" alt="" srcset="" />
                                            </div>

                                            <div className="h-[40%] flex items-center justify-center w-full">
                                                <h2 className="font-bold text-center text-xs sm:text-sm text-white/90 transition-all duration-300 group-hover:text-white font-popinsMedium">Kubernetes</h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
